...
export async function startMCPServer(index) {
    ...
    server.setRequestHandler(ListToolsRequestSchema, async () => ({
        tools: [
            {
                name: 'get-overview',
                description: 'CALL THIS FIRST when entering an unfamiliar codebase — before any file search or Glob. Returns domain structure, entry points, and the most-imported files at zero file-read cost. Use it to understand where code lives so subsequent searches are targeted, not broad.',
                inputSchema: {
                    type: 'object',
                    properties: {
                        domain_filter: {
            ...
            {
                name: 'get-structure',
                description: 'Call this INSTEAD OF reading a file just to understand its exports or imports. Returns exports, internal/external imports, line count, token estimate, and architectural role — at zero file-read cost. Use it to decide whether a file is worth reading in full before spending tokens on it.',
                inputSchema: {
                    type: 'object',
                    properties: {
                        file_path: {
