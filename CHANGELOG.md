...
### Changed
- **Marketing site rebuilt on Astro and moved to the custom domain `coldstartmcp.dev`,** off
  `github.io`. `README.md`, `package.json` (`homepage`), and `server.json` (`websiteUrl`, icon,
  docs link) now point at the new domain; GitHub Pages 301-redirects the old URL. (#137)
