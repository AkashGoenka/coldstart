...
- It has **5,891 large Java files** averaging 10.9 KB (a typical
  Example-style TS repo averages 1–3 KB).
...
The example comparison (40k files in 54 s = 1.35 ms/file) isn't an
apples-to-apples per-file number — example files are an order of
